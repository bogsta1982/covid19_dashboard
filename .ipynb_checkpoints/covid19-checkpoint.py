...
##############################################################################################################################
# Moving Romania to the first row in the datatable (You can choose any country of interest to be display on the first row)
##############################################################################################################################

def df_move1st_sg(df_t):

    #Moving Romania to the first row in the datatable
    df_t["new"] = range(1,len(df_t)+1)
    df_t.loc[df_t[df_t['Country/Region'] == 'Romania'].index.values,'new'] = 0
...
map_data.loc[map_data[map_data['Country/Region'] == 'Romania'].index.values,'new'] = 0
            ...
            [
                ...
                html.Div([  # modal div
                    html.Div([  # content div
                        ...
                        dcc.Markdown('''
                            ##### Dataset provided by Johns Hopkins University Center:
            ...
            html.Div(
                    [
                        ...
                        html.A('Covid 19 Version 2.0 Web App',
                               href='https://covidds.herokuapp.com/'),
                        html.Hr(),
                    ], className="twelve columns",
